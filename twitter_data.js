...
var verbs = ["punched", "considered", "laughed at", "selected", "marginalized", "drank", "punk'd", "drive"];
var objects = ["my", "your", "the"];
var nouns = ["cat", "puppy" , "elbow", "potato", "city-state", "electoral college", "gnu", "pony", "chair"];
